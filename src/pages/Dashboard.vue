...
export default {
  ...
  methods:{
    initBigChart(index) {
      ...
      console.log(`TEST`);
      //
            //let xapi = jsxapi.connect('wss://10.10.20.159', { username: 'admin', password: 'ciscopsdt' })
    console.log(`TEST2`);
   // xapi.command('Dial', { Number: '206844539@cisco.webex.com' })
	// .then((call) => {
